...
<style>
  ...
  .card {
      ...
      box-shadow: 0 30px 70px rgba(0,0,0,.6), inset 0 1px 1px rgba(255,255,255,0.05);
  }
  ...
  textarea#mood-input {
      ...
      font-family: 'Space Mono', monospace; font-size: .95rem; color: var(--text);
      line-height: 1.6; min-height: 90px; caret-color: var(--accent);
  }
  ...
  .btn {
      ...
      border-radius: 12px; font-size: .95rem; font-weight: 600; cursor: pointer; border: none;
      transition: all .2s cubic-bezier(0.4,0,0.2,1); font-family: inherit;
  }
  .btn-primary {
  ...
  .error-msg {
      ...
      border-radius: 10px; font-size: .9rem; color: var(--danger);
  }
  .error-msg.show { display: block; }
  .lucky-reveal {
      display: none; margin-top: 20px; padding: 14px 18px;
      background: rgba(108,99,255,.08); border: 1px solid rgba(108,99,255,.15);
      border-radius: 10px; font-size: .9rem; color: var(--accent2);
  ...
  .overlay {
      ...
      background: rgba(7,7,10,.95); backdrop-filter: blur(12px);
  ...
  .bar:nth-child(2)  { animation-delay: .1s;  height: 35px; }
  .bar:nth-child(3)  { animation-delay: .2s;  height: 50px; }
  .bar:nth-child(4)  { animation-delay: .3s;  height: 35px; }
  .bar:nth-child(5)  { animation-delay: .4s;  height: 60px; }
  .bar:nth-child(6)  { animation-delay: .5s;  height: 40px; }
  .bar:nth-child(7)  { animation-delay: .6s;  height: 60px; }
  .bar:nth-child(8)  { animation-delay: .7s;  height: 35px; }
  .bar:nth-child(9)  { animation-delay: .8s;  height: 50px; }
  .bar:nth-child(10) { animation-delay: .9s;  height: 25px; }
  .bar:nth-child(11) { animation-delay: 1.0s; height: 35px; }
  .bar:nth-child(12) { animation-delay: 1.1s; height: 20px; }
  ...
  .step-dot {
      ...
      flex-shrink: 0; position: relative; transition: all .3s;
  }
...
<div class="shell">
    <div class="card">
        ...
        <div class="terminal">
            ...
            <textarea id="mood-input" maxlength="300"
...
(() => {
    ...
    function showError(msg) {
        ...
        errorBox.textContent = 'Warning: ' + msg;
    ...
    function submit(isLucky) {
        ...
        btnGen.disabled = true; btnLucky.disabled = true;
